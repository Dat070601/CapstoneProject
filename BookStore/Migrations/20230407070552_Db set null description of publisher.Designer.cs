...
namespace BookStore.Migrations
{
    ...
    [Migration("20230407070552_Db set null description of publisher")]
    partial class Dbsetnulldescriptionofpublisher
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookStore.Models.Entities.BookAuthor", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BookStore.Models.Entities.Category", b =>
                {
                    b.HasOne("BookStore.Models.Entities.Category", null)
                        .WithMany("Categories")
                        .HasForeignKey("CategoryId");
                });
